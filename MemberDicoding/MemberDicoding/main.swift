...
func getInputInt(message: String) -> Int {
    return Int(getInputString(message: message)) ?? 0 // diberikan ?? 0 agar jika nilainya tidak valid, maka akan diubah menjadi nilai 0 
}
...
let firstName = getInputString(message: "Masukan nama depan kamu")
let lastName = getInputString(message: "Masukan nama belakang kamu")
let address = getInputString(message: "Masukan alamat kamu")
let school = getInputString(message: "Masukan nama sekolah / kampus kamu")
